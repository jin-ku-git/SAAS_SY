...
public class SalesOverviewBean implements Serializable {
    ...
    private OrderQuantityBean order_quantity;
    private GoodsQuantityBean goods_quantity;
    private GuestUnitPriceBean guest_unit_price;
    private OrderRefundQuantityBean order_refund_quantity;
    private TimeListBean time_list;
    private List<DeliveryMethodBean> delivery_method;
    private List<GoodsDetailsQuantityBean> goods_details_quantity;
    ...
    public OrderQuantityBean getOrder_quantity() {
        return order_quantity;
    }

    public void setOrder_quantity(OrderQuantityBean order_quantity) {
