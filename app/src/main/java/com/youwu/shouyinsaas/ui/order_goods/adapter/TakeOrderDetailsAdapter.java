 ...
 * 取单的订单详情适配器
 */
public class TakeOrderDetailsAdapter extends RecyclerView.Adapter<TakeOrderDetailsAdapter.myViewHodler> {
    private Context context;
    private ArrayList<CommunityBean> rechargeBeans;
    private int currentIndex = 0;

    //创建构造函数
    public TakeOrderDetailsAdapter(Context context, ArrayList<CommunityBean> goodsEntityList) {
        //将传递过来的数据，赋值给本地变量
...
//        holder.mItemGoodsImg;
        ...
        holder.total_price.setText(BigDecimalUtils.multiply(data.getGoods_number()+"",data.getGoods_price())+"");//小计
