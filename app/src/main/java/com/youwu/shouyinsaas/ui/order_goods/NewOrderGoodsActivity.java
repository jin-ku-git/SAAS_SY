...
import com.youwu.shouyinsaas.databinding.ActivityNewOrderGoodsBinding;
...
import com.youwu.shouyinsaas.ui.order_goods.adapter.NewOrderShoppingRecycleAdapter;
import com.youwu.shouyinsaas.ui.order_goods.adapter.SouSuoNewOrderRecycleAdapter;
...
public class NewOrderGoodsActivity extends BaseActivity<ActivityNewOrderGoodsBinding, NewOrderGoodsViewModel> {
        ...
        binding.souSuoEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                ...
                for (int i=0;i<SouSuoList.size();i++){
                    if (SouSuoList.get(i).getGoods_name().indexOf(s.toString()) != -1){
    ...
    private void initCommunit() {
        ...
        for (int j=0;j<20;j++){
            ...
            communityBean.setGoods_name("云南辣椒炒肉"+j);
            communityBean.setGoods_price("7."+j);
            communityBean.setGoods_number(j);

            communityBean.setGoods_number(j);
            communityBean.setPosition(j);
            communityBean.setCom_number_state(0);
    ...
    private void showDialog(final CommunityBean data, final int position) {
        ...
        String number = data.getGoods_number()+"";
        ...
        custom_keyboard.setListener(new MyCustKeybords.OnKeyBoradConfirm() {
            ...
            public void onConfirm() {
                if ("".equals(goods_number.getText().toString())||goods_number.getText().toString()==null){
                    ...
                    data.setGoods_number(Integer.parseInt(goods_number.getText().toString()));
