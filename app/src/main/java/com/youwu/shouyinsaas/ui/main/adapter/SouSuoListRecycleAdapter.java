...
import com.youwu.shouyinsaas.utils_view.FindUtil;
...
//        holder.mItemGoodsImg;
        ...
        KLog.d("getCom_name:"+data.getGoods_name());
        if ("".equals(data.getSou_suo_text())||data.getSou_suo_text()==null){
            holder.item_sousuo_name.setText(data.getGoods_name());
        }else {

            holder.item_sousuo_name.setText(FindUtil.findSearch(getResources().getColor(R.color.main_color), data.getGoods_name(), data.getSou_suo_text()));
        }
