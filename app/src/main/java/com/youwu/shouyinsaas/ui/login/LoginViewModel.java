...
import com.youwu.shouyinsaas.ui.login.bean.LogBean;
                ...
                .subscribe(new DisposableObserver<BaseBean<Object>>() {
                    ...
                    public void onNext(BaseBean response) {
                        ...
                        if (response.isOk()){
                            ...
                            AppApplication.spUtils.put("accessToken", logBean.getAccessToken());
                            AppApplication.spUtils.put("tokenType", logBean.getTokenType());
                            //保存最新的登录时间
