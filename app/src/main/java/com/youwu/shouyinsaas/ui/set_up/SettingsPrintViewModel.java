...
public class SettingsPrintViewModel extends BaseViewModel<DemoRepository> {
    ...
    public SettingsPrintViewModel(@NonNull Application application, DemoRepository repository) {
