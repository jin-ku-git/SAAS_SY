package com.youwu.shouyinsaas.ui.set_up.adapter;
...
public class PrintListAdapter extends RecyclerView.Adapter<PrintListAdapter.myViewHodler> {
    private Context context;
    private List<String> goodsEntityList;
    private int currentIndex = 0;

    //创建构造函数
    public PrintListAdapter(Context context, List<String> goodsEntityList) {
        //将传递过来的数据，赋值给本地变量
    ...
    public myViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        //创建自定义布局
        View itemView = View.inflate(context, R.layout.item_print_layout, null);
...
//        holder.mItemGoodsImg;
        ...
        holder.NameText.setText(goodsEntityList.get(position));
    ...
    class myViewHodler extends RecyclerView.ViewHolder {
        ...
        private TextView NameText;//商品名称,商品价格
    ...
    public interface OnPopupListener {
        void onPopup(String lists, int position);
    }
