...
//    private List<CommunityBean.SpecsBean> specs;
    ...
    private final String[] GOODS_COLUMNS = new String[]{"goods_id_sku","goods_id", "goods_sku", "goods_name",
            ...
            , "group_sort", "group_img", "goods_number", "com_number_state","details","package_id","type","store_goods_sku","store_goods_id"};
            ...
            for (int i = 0; i < goodsBeans.size(); i++) {
                ...
                if (null != goodsBean) {
                    ...
                    if (goodsBean.getType()==1){//商品
                        contentValues.put("goods_id_sku", (goodsBean.getStore_goods_id()+""+goodsBean.getStore_goods_sku())+"");
                    }else {//套餐
...
//            Log.e(TAG,"cursor  "+cursor);
    ...
    private CommunityBean parseGoodS(Cursor cursor) {
        ...
        goods.setStore_goods_sku(cursor.getString(cursor.getColumnIndex(GOODS_COLUMNS[17])));
        goods.setStore_goods_id(cursor.getInt(cursor.getColumnIndex(GOODS_COLUMNS[18])));
