...
public class InventoryDao {
    ...
    private final String[] INVENTORY_COLUMNS = new String[]{"goods_id","goods_sku", "goods_name",
            "goods_price","goods_img", "stock", "category_id", "category_name","store_goods_sku","store_goods_id"};
...
//            Log.e(TAG,"cursor  "+cursor);
    ...
    private CommunityBean parseGoodS(Cursor cursor) {
        ...
        goods.setStore_goods_sku(cursor.getString(cursor.getColumnIndex(INVENTORY_COLUMNS[8])));
        goods.setStore_goods_id(cursor.getInt(cursor.getColumnIndex(INVENTORY_COLUMNS[9])));
